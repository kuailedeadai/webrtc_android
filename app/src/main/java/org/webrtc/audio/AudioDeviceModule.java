...
/**
 * This interface is a thin wrapper on top of a native C++ org.webrtc::AudioDeviceModule (ADM). The
...
public interface AudioDeviceModule {
  /**
   * Returns a C++ pointer to a org.webrtc::AudioDeviceModule. Caller does _not_ take ownership and
